...
class MrpBom(models.Model):
    ...
    x_studio_direct_general_cost = fields.One2many(
        'x_mrp_bom_general_cost', 'x_studio_bom_general_cost_ids',
        string='Direct General Cost')
    x_studio_last_updated_date_cost = fields.Datetime(string='Last Updated Date (Cost)')
    x_studio_one2many_field_4rhw9 = fields.One2many(
        'x_mrp_bom_material_cos', 'x_studio_bom_material_cost_ids',
        string='Direct Material Cost')
    x_studio_one2many_field_bOopH = fields.One2many(
        'x_mrp_bom_overhead_cos', 'x_studio_bom_overhead_cost_ids',
        string='Direct Overhead Cost')
    x_studio_one2many_field_jPlQP = fields.One2many(
        'x_mrp_bom_labour_cost', 'x_studio_bom_labour_cost_ids',
